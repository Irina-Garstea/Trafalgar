...
export type ReviewUserQueryVariables = Exact<{
  sort: Maybe<Array<Maybe<ReviewSort>> | Maybe<ReviewSort>>;
}>;


export type ReviewUserQuery = { __typename?: 'Query', Page: Maybe<{ __typename?: 'Page', reviews: Maybe<Array<Maybe<{ __typename?: 'Review', id: number, userId: number, summary: Maybe<string>, user: Maybe<{ __typename?: 'User', name: string, avatar: Maybe<{ __typename?: 'UserAvatar', medium: Maybe<string> }>, options: Maybe<{ __typename?: 'UserOptions', titleLanguage: Maybe<UserTitleLanguage>, profileColor: Maybe<string> }> }> }>>> }> };
...
/**
 * __useReviewUserQuery__
 *
 * To run a query within a React component, call `useReviewUserQuery` and pass it any options that fit your needs.
 * When your component renders, `useReviewUserQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useReviewUserQuery({
 *   variables: {
 *      sort: // value for 'sort'
 *   },
 * });
 */
export function useReviewUserQuery(baseOptions?: Apollo.QueryHookOptions<ReviewUserQuery, ReviewUserQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ReviewUserQuery, ReviewUserQueryVariables>(ReviewUserDocument, options);
      }
export function useReviewUserLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ReviewUserQuery, ReviewUserQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ReviewUserQuery, ReviewUserQueryVariables>(ReviewUserDocument, options);
        }
export type ReviewUserQueryHookResult = ReturnType<typeof useReviewUserQuery>;
export type ReviewUserLazyQueryHookResult = ReturnType<typeof useReviewUserLazyQuery>;
export type ReviewUserQueryResult = Apollo.QueryResult<ReviewUserQuery, ReviewUserQueryVariables>;